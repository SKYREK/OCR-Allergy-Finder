...
class _HomeScreenState extends State<HomeScreen> {
  ...
  String findBiggestDate(String text) {
    ...
    RegExp dateRegex = RegExp(r'\d{2}-\d{2}-\d{4}|\d{4}-\d{2}-\d{2}|\d{4}.\d{2}.\d{2}|\d{2}/\d{2}/\d{4}|\d{4}/\d{2}/\d{2}');
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: _isSettingsButtonPressed ? Colors.red : Colors.white,
                          width: 2.0,
                        ),
                      ),
                      child: const Icon(
                  ...
                  InkResponse(
                    onTap: ()async {
                      ...
                      if(_expirySelected){
                        ...
                        List<String> words = await getTextFromImage().then((value) => value!);
