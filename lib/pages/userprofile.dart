...
class _userprofileState extends State<userprofile> {
  ...
  void loadDate() async {
    ...
    bool verifiedMail = FirebaseAuth.instance.currentUser!.emailVerified;
    setState(() {
      _userName = name;
      _usertoxic = toxic;
      _useremail = email;
      _verified = verifiedMail;
    });
  }
                  ...
                  child: Container(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                            ...
                            showDialog(
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  ...
                                  content: const Text(
                                      "Click on the link you have recieved in your email to verify your account and relogin to the app to update state."),
                                  actions: <Widget>[
                                    TextButton(
                                      child: const Text('Relogin later'),
                                      onPressed: () {
                                        Navigator.of(context).pop();
                                      },
                                    ),
                        ...
                        child: _verified
                            ? Text("Verified".toUpperCase())
                            : Text("Send verification".toUpperCase()),
                        style: ButtonStyle(
